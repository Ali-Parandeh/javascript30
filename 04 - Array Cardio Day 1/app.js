...
const sortedInventors = inventors.sort((inventor1, inventor2) => inventor1.year - inventor2.year)
...
console.table(yearsLived) // original array mutated


// 5. Sort the inventors by years lived
inventors.forEach(inventor => inventor.yearsLived = inventor.passed - inventor.year)
const sortedInventorsByYearsLived = inventors.sort((inventor1, inventor2) => inventor1.yearsLived - inventor2.yearsLived)
console.table(sortedInventorsByYearsLived) // original array mutated
